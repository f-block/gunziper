...
public class DeflateDeUnpacker extends AbstractDeEncrypter {

    String decryptIdentifierString = "inflate";
    String encryptIdentifierString = "deflate";
    ...
    public byte[] getDecryptedBytearray(byte[] encryptedByteArray) {
        ...
        try {
            ...
            inflateIn = new InflaterInputStream(byteIn);
